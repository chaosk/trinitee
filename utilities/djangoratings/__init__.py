...
RatingField = lazy_object('utilities.djangoratings.fields.RatingField')
AnonymousRatingField = lazy_object('utilities.djangoratings.fields.AnonymousRatingField')
Rating = lazy_object('utilities.djangoratings.fields.Rating')