...
class DeprecationTest(TestCase):
    ...
    def test_dashboard(self):
        from utilities.admin_tools.dashboard import models
    ...
    def test_dashboard_new(self):
        from utilities.admin_tools import dashboard
        ...
        from utilities.admin_tools.dashboard import modules
    ...
    def test_menu(self):
        from utilities.admin_tools.menu import models
    ...
    def test_menu_new(self):
        from utilities.admin_tools import menu
        self.assertNotDeprecated(menu.Menu)
        self.assertNotDeprecated(menu.DefaultMenu)

        from utilities.admin_tools.menu import items
